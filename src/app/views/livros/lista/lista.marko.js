...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/alura-node1-casa-do-codigo$1.0.0/src/app/views/livros/lista/lista.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>Listagem de livros</h1><table id=\"livros\"><tr><td>ID</td><td>Titulo</td><td>Preço</td><td>Editar</td><td>Remover</td></tr>");
...
marko_template.meta = {
    id: "/alura-node1-casa-do-codigo$1.0.0/src/app/views/livros/lista/lista.marko",
    tags: [
