...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/alura-node1-casa-do-codigo$1.0.0/src/app/views/livros/form/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<div><label for=\"titulo\">Título:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" value=\"" +
    ...
    "\" placeholder=\"150.75\"></div><div><label for=\"decricao\">Descrição:</label><textarea cols=\"20\" rows=\"10\" id=\"descricao\" name=\"descricao\" value=\"" +
...
marko_template.meta = {
    id: "/alura-node1-casa-do-codigo$1.0.0/src/app/views/livros/form/form.marko",
    tags: [
